...
sky="#99d1db"
sapphire="#85c1dc"
blue="#91B4D5" # first left box and battery
lavender="#babbf1"
text="#c6d0f5"
subtext1="#b5bfe2"
subtext0="#a5adce"
...
mantle="#292c3c"
crust="#232634"
eggplant="#5DE4c7" #user box
sky_blue="ADD7FF"
spotify_green="#5DE4c7"
...
TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR:-$offWhite}
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		#"mailcount 9 255"
		"now_playing $thm_bg $brightMint"
		"cpu $thm_bg $offWhite"
		"battery $thm_bg $brightMint"
		# "load 237 167"
